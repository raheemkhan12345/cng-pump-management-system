        ...
        <div className="sr-page-container">
            ...
            <div className="sr-filter-tabs-container">
                {['Daily', 'Weekly', 'Monthly'].map((tab) => (
                    <button
                        key={tab}
                        className={`sr-tab-btn ${activeTab === tab
                                ? 'active'
                                : ''
                            }`}
                        onClick={() =>
            ...
            <div className="sr-stats-grid">
                ...
                <div className="sr-stat-card">
                    <div className="sr-card-content">
                        ...
                        <h2 className="sr-card-amount">
                            <span className="sr-currency">
                                Rs.
                            </span>{' '}

                            {formatCurrency(
                                reportStats.grossRevenue
                            )}
                        </h2>
                    </div>
                                ...
                                currentTransactions.map(
                                    (item) => (
                                        <tr key={item.id}>
                                            ...
                                            <td>
                                                <span className="sr-badge-completed">
                                                    {item.status}
                                                </span>
                                            </td>
                    ...
                    <div className="sr-pagination-footer">
                        ...
                        <div className="sr-pagination-controls">
                            ...
                            {pageNumbers.map((page) => (
                                <button
                                    key={page}
                                    className={`sr-page-num ${currentPage === page
                                            ? 'active'
                                            : ''
                                        }`}
                                    onClick={() =>
